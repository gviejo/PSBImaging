...
info = pd.read_csv('/home/guillaume/PSBImaging/python/datasets_SAMERIGIDBODY2.txt', comment = '#', header = None)
...
# DIFF PEAKS + SESSIONS
####################################################################################
diffpeaks = computePeaksAngularDifference(alltc, sessions = [0,1,2])
